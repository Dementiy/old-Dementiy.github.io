...
Теперь постройте модель на собранных вами данных с новостного сайта HackerNews и добавьте обработчик запроса для вывода ранжированной таблицы новостей:
